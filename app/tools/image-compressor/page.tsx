  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <p className="text-gray-600 mb-8">Compress and resize images while maintaining quality</p>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          {processing && (
            <div className="mt-4 text-center text-blue-600 font-medium">Compressing images...</div>
          )}
        </div>
