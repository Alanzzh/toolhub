  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Markdown Preview</h1>
        <p className="text-gray-600 mb-8">Write and preview Markdown in real-time</p>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="text-sm font-medium text-gray-700">Markdown Input</label>
              <button onClick={() => setInput("")} className="text-sm text-gray-500 hover:text-gray-700">Clear</button>
            </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <button onClick={copy} className="text-sm text-blue-600 hover:underline">Copy HTML</button>
            </div>
            <div
