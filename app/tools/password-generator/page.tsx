  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Password Generator</h1>
        <p className="text-gray-600 mb-8">Generate secure random passwords</p>
            ...
            <div className="grid grid-cols-2 gap-3">
              {Object.entries(options).map(([key, val]) => (
                <label key={key} className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-700">{key === 'uppercase' ? 'Uppercase' : key === 'lowercase' ? 'Lowercase' : key === 'numbers' ? 'Numbers' : 'Symbols'}</span>
