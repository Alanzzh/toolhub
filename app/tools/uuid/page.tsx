  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-2">UUID Generator</h1>
        <p className="text-gray-600 mb-8">Generate random UUIDs (v4)</p>
        ...
        {uuids.length > 0 && (
          <div className="mt-6">
            <div className="flex justify-between items-center mb-3">
              <span className="text-sm font-medium text-gray-700">{uuids.length} generated</span>
              <button onClick={copyAll} className="text-sm text-blue-600 hover:underline">Copy All</button>
            </div>
