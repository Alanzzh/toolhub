  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Color Picker</h1>
        <p className="text-gray-600 mb-8">Pick colors and get values in different formats</p>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Color Shades</h2>
